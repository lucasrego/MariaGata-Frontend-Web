...
?>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-2 col-md-offset-6">
							<button class="btn btn-primary" id="btnVoltar" name="btnVoltar"><i class="fa fa-arrow-left"></i> Retornar ao Maria Gata</button>
						</div>
					</div>
				</div>
				<!-- END Main Content -->
		...
		<script type="text/javascript" src="assets/jquery-redirect/jquery.redirect.min.js"></script>
